package v2update.subaru.ios.usa.status;
...
public class SubaruVehicleStatusIOS extends SeeTestKeywords {
    String testName = " - SubaruVehicleStatus-IOS";
    ...
    public static void doors() {
        ...
        sc.verifyElementNotFound("NATIVE", "xpath=//*[@text='Tire Pressure']", 0);
    ...
    public static void windows() {
        ...
        if(!sc.isElementFound("NATIVE","xpath=//*[@text='Doors']")) {
            reLaunchApp_iOS();
            click("NATIVE", "xpath=//*[@text='Status']", 0, 1);
    ...
    public static void pullDownRefreshInStatusSection() {
        ...
        sc.flickElement("NATIVE","xpath=//*[@text='Doors']",0,"down");
        ...
        expectedText = new String[]{"Odometer", "Double tap to open vehicle switcher!", "Fuel", "Remote", "Status", "Health", "Service", "Pay", "Shop", "Find", "Doors", "Windows", "VehicleStatusScreen_refresh_button"};
