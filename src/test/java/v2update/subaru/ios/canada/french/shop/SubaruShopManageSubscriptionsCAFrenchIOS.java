package v2update.subaru.ios.canada.french.shop;
...
public class SubaruShopManageSubscriptionsCAFrenchIOS extends SeeTestKeywords {
    String testName = " - SubaruShopManageSubscriptionCAFrench-IOS";
    ...
    public static void validateShopSubscriptionCard(){
        ...
        if(!sc.isElementFound("NATIVE","xpath=//*[contains(@id,'Vehicle image')]"))
            reLaunchApp_iOS();
        verifyElementFound("NATIVE","xpath=//*[@id='Boutique']",0);
        click("NATIVE","xpath=//*[@id='Boutique']",0,1);
