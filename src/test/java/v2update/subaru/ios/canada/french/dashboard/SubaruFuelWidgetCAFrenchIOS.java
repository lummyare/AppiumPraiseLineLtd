...
public class SubaruFuelWidgetCAFrenchIOS extends SeeTestKeywords {
    String testName = " - SubaruFuelWidgetEVCAFrench-IOS";
    ...
    public static void fuelWidgetEV() throws IOException {
        ...
        if(sc.isElementFound("NATIVE", "xpath=//*[@text='chargingBattery' or @text='PluggedIcon']", 0)) {
            ...
            if(sc.isElementFound("NATIVE", convertTextToUTF8("//*[contains(@text,'Chargé à')]"), 0)) {
                ...
                verifyElementFound("NATIVE", convertTextToUTF8("//*[contains(@text,' jusq plein')]"), 0);
                String estimatedTime = sc.elementGetText("NATIVE", convertTextToUTF8("//*[contains(@text,' jusq plein')]"), 0);
            ...
            String chargedVal = sc.elementGetText("NATIVE", "xpath=//*[@name='fuel_view_percent_label']", 0);
            createLog("Charged value is: "+chargedVal);
            String val = convertTextToUTF8("à ");
            String[] chargedValArr = chargedVal.split(val);
            String[] chargedValSplitArr = chargedValArr[1].split("%");
            sc.report("Verify Charged value is Numeric ", CommonUtils.isNumeric(chargedValSplitArr[0]));
        }
    ...
    public static void progressBarColorValidationEV() throws IOException {
        ...
        if(sc.isElementFound("NATIVE","xpath=//*[contains(@text,'BatteryLevel')]")){
            ...
            String val = convertTextToUTF8("à ");
            String[] chargedValArr = chargeValueDisplayed.split(val);
            String[] chargedValSplitArr = chargedValArr[1].split("%");
            int chargeValue = Integer.parseInt(chargedValSplitArr[0]);
        ...
        if(sc.isElementFound("NATIVE","xpath=//*[@text='chargingBattery']")) {
            ...
            String chargeAvailable = sc.elementGetText("NATIVE", convertTextToUTF8("//*[contains(@text,' jusq plein')]"), 0);
