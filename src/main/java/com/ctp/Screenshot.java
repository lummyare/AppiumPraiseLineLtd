...
//        BufferedImage originalImage = ImageIO.read(file);
     ...
     *
     * @param driver   Appium driver instance should be initiated in your test.
     * @param elm      By object of locator for the element needed to get screenshot of.
     * @param filePath File path to save the screenshot to.
     * @throws IOException as it's handling file path of image.
     */
    public static void takeElementScreenshot(AppiumDriver driver, MobileElement elm, String filePath) throws IOException {
        ...
        int x = elm.getRect().getX();
        int y = elm.getRect().getY();
        int w = elm.getRect().getWidth();
        int h = elm.getRect().getHeight();
